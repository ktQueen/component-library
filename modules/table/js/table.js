...
define(['jquery', 'cssFile!modules/table/css/table.css'], function($) {
    ...
    Table.prototype = {
        ...
        renderPagination: function() {
            ...
            } else if (this.setting.loadType == "onlyCurPage") {} else {
            ...
            if (that.setting.data.length <= 0) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        that.pageBar();
                        that.setting.callback && that.setting.callback(data);
                    }
                });
            } else {
                ...
                that.setting.callback && that.setting.callback(that.setting.data);
            }
        },
        goto: function(page) {
            //页面跳转，调用getData
