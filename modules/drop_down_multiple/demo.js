...
require([
    ...
    var demo1 = new Multiple({
        ...
        //不同的一些参数配置
        isSelectAll: true, //是否有全部选项，只有多选才有的属性
        /*单选*/
        isRequired: true, //是否为必填，单选和单选搜索可用，多选和所选搜索不可用
        /*搜索框*/
        isSearch: true,
