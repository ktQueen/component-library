/**
 * 下拉框单选搜索菜单组件
 * @module drop_down_single_search
 */
define([
    'modules/drop_down_base/js/drop_down_base',//下拉按钮的基础文件
    'modules/drop_down_single_search/js/single_search_menu'//单选搜索的菜单文件
], function(Base, SingleSearchMenu) {
    /**
     * @class
     * @classdesc 下拉框单选搜索菜单组件
     * @alias DropDownSingleSearch
     ...
     *
     * @param {string} opts.type='singleSearch' - 要创建的表单字段的类型
     ...
     * @requires 'require'
     */
    var DropDownSingleSearch=function(){};
    DropDownSingleSearch.prototype = {
        /*初始化*/
        init: function(opts) {
            var _this = this;
            _this.execute(opts, SingleSearchMenu);
        },
        /* 参数设置*/
    ...
    return Base.extend(DropDownSingleSearch);
});