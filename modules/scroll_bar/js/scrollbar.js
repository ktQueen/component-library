...
require.config({
    paths: {
        ...
        'mousewheel':'modules/scroll_bar/js/jquery.mousewheel',
...
define([
    'jquery',
    'mousewheel',
    'cssFile!modules/scroll_bar/css/perfect-scrollbar.css'
],function($){
((function($) {
    $.fn.perfectScrollbar = function(option) {
        ...
        var updateBarSizeAndPosition = function() {
            ...
            if(content_height<scrollbar_y_top + $this.scrollTop()+scrollbar_y_height){
                $scrollbar_y.css({top: content_height - scrollbar_y_height});
            }
        };
...
//                console.log('333333333');
        ...
        var fixed=function(obj){
//            console.log(obj);
            if($this.attr('id')=="listTableBox"){
                $('.fixedCol').css({
                ...
                $('.fixedCol.fixedRow').css({
                    'z-index':3
                });
            }
            if($this.hasClass('fixTab')){
                $this.find('.fixNav').css('margin-top',  $this.scrollTop());
            }
        };
